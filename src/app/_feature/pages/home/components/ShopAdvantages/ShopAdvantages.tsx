    ...
    },
    {
      ...
      image: (
        ...
        >
          ...
          <path d="M29 16c0 7.17-5.83 13-13 13s-13-5.83-13-13c0-7.17 5.83-13 13-13 3.6 0 6.94 1.44 9.38 4h-3.38v2h7v-7h-2v3.82c-2.83-3.080-6.76-4.82-11-4.82-8.27 0-15 6.73-15 15s6.73 15 15 15c8.27 0 15-6.73 15-15h-2z"></path>
          <path d="M15 7.34v9.24l5.8 2.9 0.9-1.79-4.7-2.35v-8z"></path>
        </svg>
      ),
      title: "Next Day Delivery",
      text: "Free– spend over $99",
    },
    {
      id: 3,
      image: (
        ...
        >
          ...
          <path d="M16 32c-1.020 0-2.050-0.32-2.92-0.95l-0.81-0.59c-0.51-0.37-1.12-0.57-1.75-0.57h-1c-2.16 0-4.060-1.38-4.72-3.43l-0.31-0.96c-0.2-0.6-0.57-1.12-1.080-1.49l-0.81-0.59c-1.75-1.27-2.47-3.5-1.8-5.55l0.31-0.95c0.2-0.6 0.2-1.24 0-1.84l-0.31-0.95c-0.67-2.050 0.060-4.28 1.8-5.55l0.8-0.59c0.52-0.38 0.89-0.89 1.090-1.49l0.31-0.95c0.67-2.050 2.57-3.43 4.72-3.43h1c0.63 0 1.24-0.2 1.75-0.57l0.81-0.59c1.75-1.27 4.090-1.27 5.84 0l0.81 0.59c0.51 0.37 1.12 0.57 1.75 0.57h1c2.16 0 4.060 1.38 4.72 3.43l0.31 0.95c0.2 0.6 0.57 1.12 1.080 1.49l0.81 0.59c1.75 1.27 2.47 3.5 1.8 5.55l-0.31 0.95c-0.2 0.6-0.2 1.24 0 1.84l0.31 0.95c0.67 2.050-0.060 4.28-1.8 5.55l-0.81 0.59c-0.51 0.37-0.89 0.89-1.080 1.49l-0.31 0.95c-0.67 2.050-2.56 3.43-4.72 3.43h-1c-0.63 0-1.24 0.2-1.75 0.57l-0.81 0.59c-0.87 0.64-1.9 0.96-2.92 0.96zM9.52 4.1c-1.29 0-2.43 0.83-2.83 2.060l-0.31 0.95c-0.33 1-0.95 1.86-1.8 2.48l-0.81 0.59c-1.050 0.76-1.48 2.1-1.080 3.33l0.31 0.95c0.33 1 0.33 2.070 0 3.070l-0.31 0.95c-0.4 1.23 0.030 2.57 1.080 3.33l0.81 0.59c0.85 0.62 1.48 1.48 1.8 2.48l0.31 0.95c0.4 1.23 1.54 2.060 2.83 2.060h1c1.060 0 2.070 0.33 2.92 0.95l0.81 0.59c1.050 0.76 2.46 0.76 3.5 0l0.81-0.59c0.85-0.62 1.86-0.95 2.92-0.95h1c1.29 0 2.43-0.83 2.83-2.060l0.31-0.95c0.33-1 0.95-1.86 1.8-2.48l0.81-0.59c1.050-0.76 1.48-2.1 1.080-3.33l-0.31-0.95c-0.33-1-0.33-2.060 0-3.070l0.31-0.95c0.4-1.23-0.030-2.57-1.080-3.33l-0.81-0.59c-0.85-0.62-1.48-1.48-1.8-2.48l-0.31-0.95c-0.4-1.23-1.54-2.060-2.83-2.060h-1c-1.060 0-2.060-0.33-2.92-0.95l-0.81-0.59c-1.050-0.76-2.46-0.76-3.5 0l-0.81 0.59c-0.85 0.62-1.86 0.95-2.92 0.95h-1z"></path>
          <path d="M16 26c-5.51 0-10-4.49-10-10s4.49-10 10-10c5.51 0 10 4.49 10 10s-4.49 10-10 10zM16 8c-4.41 0-8 3.59-8 8s3.59 8 8 8 8-3.59 8-8-3.59-8-8-8z"></path>
        ...
        {data.map((item) => (
          <div key={item.id} className="flex items-center  gap-x-2 ">
            ...
            <div className="text-sm">
                ...
                <p className="text-[#7c818b]">{item.text}</p>
            </div>
          </div>
        ))}
      </div>
