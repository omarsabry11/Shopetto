        ...
        <div className="flex items-center gap-8 flex-wrap mb-20">
          <div className="flex-1 min-w-[300px]">
            ...
            <p className="text-lg text-[#7E7E7E] mb-5">
              ...
              essentials, and more — all in one place. Discover unbeatable
              prices and fast delivery.
            </p>
            <p className="text-lg text-[#7E7E7E] mb-8">
              We believe shopping should be simple, fun, and rewarding. That’s
              why we offer quality products, exclusive deals, and a secure
              platform.
            </p>
          </div>
